...
ROLES = {
    ...
    "ccf-paper-reader": ("Read papers", "论文精读", "論文精讀"),
    "ccf-paper-translator": ("Full translation", "全文翻译", "全文翻譯"),
...
GROUPS = {
    ...
    "delivery": ["ccf-paper-reader", "ccf-paper-translator", "ccf-visual-composer", "ccf-submission-checker", "ccf-paper-to-exemplar"],
...
def build_hero(lang: str) -> None:
    copy = {
        "en": {
            ...
            "subtitle_lines": [
                "19 focused skills for reading, translation, literature,",
                "experiments, writing, review, figures, and submission.",
            ],
        ...
        "zh-CN": {
            ...
            "subtitle_lines": ["19 个彼此协作的 skills，覆盖阅读、翻译、文献、实验、写作、审稿、绘图与投稿。"],
        ...
        "zh-TW": {
            ...
            "subtitle_lines": ["19 個彼此協作的 skills，涵蓋閱讀、翻譯、文獻、實驗、寫作、審稿、繪圖與投稿。"],
...
def build_catalog(lang: str) -> None:
    ...
    subtitle = {
        "en": "19 skills with distinct responsibilities and purposeful collaboration",
        "zh-CN": "19 个 skills 各有专长，并在需要时彼此协作",
        "zh-TW": "19 個 skills 各有專長，並在需要時彼此協作",
    }[lang]
...
def build_routing(lang: str) -> None:
    ...
    rows = {
        "en": [
            ...
            ("Paper understanding", "ccf-paper-reader", "summarizes and explains one paper"),
            ("Full-paper translation", "ccf-paper-translator", "preserves the complete source and original figures"),
        ...
        "zh-CN": [
            ...
            ("论文精读", "ccf-paper-reader", "总结并解释一篇论文"),
            ("全文翻译", "ccf-paper-translator", "保留完整原文和全部原图"),
        ...
        "zh-TW": [
            ...
            ("論文精讀", "ccf-paper-reader", "總結並解釋一篇論文"),
            ("全文翻譯", "ccf-paper-translator", "保留完整原文和全部原圖"),
    ...
    for task, owner, rule in rows:
        ...
        y += 78
    write_svg("ccfa-skills-routing", lang, svg(1200, 790, "\n".join(body)))
