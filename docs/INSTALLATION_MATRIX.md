...
| --- | --- | --- |
| Full workflow | All 19 runtime skills | Complete CCFA flow, including paper reading and faithful full translation. |
| Paper reading and translation | `ccf-common`, `ccf-paper-reader`, `ccf-paper-translator` | Reads or translates supplied papers without the broader idea, experiment, writing, or submission workflow. |
