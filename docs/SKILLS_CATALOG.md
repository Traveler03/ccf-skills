...
| `ccf-paper-translator` | Paper translation | Translate one complete paper faithfully and preserve its structure, equations, citations, tables, appendices, and every original figure. | 论文全文翻译、完整翻译原文、逐段翻译、保留原论文图片。 | complete translation, bilingual translation, original-figure document | Summarizing, reviewing, rewriting, humanizing, redrawing figures, or inventing missing text. |
