...
CCFA is a paper-project workflow family, not a loose collection of unrelated writing prompts. The current 19-skill architecture has one owner per responsibility area, a first-priority humanization overlay, and `ccfa.yaml` plus explicit artifact contracts to keep stages connected.
...
scaffold -> orchestrate -> optimize idea -> review idea
         ...
         -> design experiments -> compose visuals -> optional paper reading/translation
         -> optional exemplar extraction
...
| Paper reading | `ccf-paper-reader` | Produces Chinese-first research notes and selective translations; complete translation stays with translator. |
| Full-paper translation | `ccf-paper-translator` | Preserves the complete source and original figures; it does not summarize, review, rewrite, humanize, or redraw. |
