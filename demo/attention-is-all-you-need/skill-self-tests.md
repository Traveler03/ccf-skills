...
The current runtime surface has 19 skills. These smoke prompts cover only distinct, decision-relevant routing boundaries in the Attention/ICLR demo; they are not repeated merely to exercise every skill.
...
| Read the source paper into a Chinese-first method and experiment note. | `ccf-paper-reader` | `artifacts/00-original-paper-reading.md`. |
| Translate the complete source paper while preserving every original figure. | `ccf-paper-translator` | Routing and full-translation contract; no condensed demo artifact substitutes for the complete paper. |
